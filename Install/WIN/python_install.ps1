...
Invoke-WebRequest -Uri "https://www.python.org/ftp/python/3.7.0/python-3.7.0.exe" -OutFile "$tempFolder/python-3.7.0.exe"

Write-Host "Installing python 3.7.0..."
$fullpath = join-path -path $tempFolder -childpath "python-3.7.0.exe"
